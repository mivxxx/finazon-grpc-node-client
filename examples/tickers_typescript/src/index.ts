...
import {FindTickersCryptoRequest, FindTickerCryptoResponse} from 'mivxxx-finazon-grpc-node-client/tickers_pb';
import {TickersServiceClient} from 'mivxxx-finazon-grpc-node-client/tickers_grpc_pb';
